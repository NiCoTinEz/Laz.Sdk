...
public interface IAuthService
{
    ...
    Task<LazAccessToken> CreateAccessTokenAsync(string code, LazCredentials? credentials = null, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="LazException">Thrown when the platform returns an error response.</exception>
    Task<LazAccessToken> RefreshAccessTokenAsync(string refreshToken, LazCredentials? credentials = null, CancellationToken cancellationToken = default);
}
